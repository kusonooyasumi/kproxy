<script lang="ts">
  ...
  window.electron.on('ffuf-output', (data: string) => {
    output.update(current => current + data);
  });

  window.electron.on('ffuf-complete', (exitCode: number) => {
    output.update(current => current + `\nFFuf process completed with exit code ${exitCode}\n`);
    isRunning.set(false);
  });

  window.electron.on('ffuf-error', (errorMsg: string) => {
    output.update(current => current + `\nError: ${errorMsg}\n`);
    isRunning.set(false);
  });
  ...
  return () => {
    ...
    window.electron.removeAllListeners('ffuf-error');
  };
});
</script>
...
<div class="ffuf-container">
  ...
  <div class="tabs">
    ...
    <div class="tab-content" id="http">
      ...
      <div class="form-group">
        ...
        <select id="method" bind:value={$options.method}>
    ...
    <div class="tab-content" id="matchers">
      ...
      <div class="form-group">
        ...
        <select id="matcherMode" bind:value={$options.matcherMode}>
    ...
    <div class="tab-content" id="filters">
      ...
      <div class="form-group">
        ...
        <select id="filterMode" bind:value={$options.filterMode}>
          <option value="or">OR</option>
          <option value="and">AND</option>
        </select>
      </div>
    ...
    <div class="tab-content" id="input">
      ...
      <div class="form-group">
        ...
        <select id="mode" bind:value={$options.mode}>
    ...
    <div class="tab-content" id="output">
      ...
      <div class="form-group">
        ...
        <select id="outputFormat" bind:value={$options.outputFormat}>
  ...
  <div class="control-buttons">
    <button on:click={runFFuf} disabled={$isRunning} class="run-btn">Run FFuf</button>
    <button on:click={stopFFuf} disabled={!$isRunning} class="stop-btn">Stop FFuf</button>
